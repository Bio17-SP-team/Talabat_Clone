 ...
 */
public class Create_Meal extends javax.swing.JFrame {

    /**
     * Creates new form Create_Meal
     */
    public Create_Meal() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        new Update_Meal().setVisible(rootPaneCheckingEnabled);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Create_Meal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
